...
test(
  ...
  async () => {
    ...
    expect(legacy.text).toContain("checks-lint: 11 gate(s) pass");
...
test(
  ...
  async () => {
    ...
    expect(pushed.text).toContain("checks-lint: 11 gate(s) pass");
    ...
    expect(violated.text).toContain(
      "checks-lint: 2 of 11 gate(s) failed: checks-comment-gate, checks-suppressions-ratchet\n",
    );
...
test(
  ...
  async () => {
    ...
    expect(passed.text).toContain("checks-lint: 11 gate(s) pass");
...
test(
  ...
  async () => {
    ...
    expect(raised.text).toContain("checks-lint: 1 of 11 gate(s) failed: checks-suppressions-ratchet\n");
    ...
    expect(directive.text).toContain("checks-lint: 1 of 11 gate(s) failed: checks-comment-gate\n");
    ...
    expect(foreign.text).toContain("checks-lint: 1 of 11 gate(s) failed: checks-commit-identity\n");
    ...
    expect(cleared.text).toContain("checks-lint: 11 gate(s) pass");
...
test(
  ...
  async () => {
    ...
    expect(everyGate.text).toContain("checks-lint: 1 of 11 gate(s) failed: checks-test-layout\n");
