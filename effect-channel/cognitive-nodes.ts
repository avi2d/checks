...
export type PlainC =
  ...
  | JSXExpression
  | JSXSpread;
export type Ignored = Identifier | Literal | ThisMarker | Leaves;
...
export const IGNORED_TYPES: readonly string[] = ["Identifier", "Literal", "ThisExpression", "Super", "MetaProperty", "Hashbang", "EmptyStatement", "DebuggerStatement", "TemplateElement", "PrivateIdentifier", "ImportDeclaration", "ImportSpecifier", "ImportDefaultSpecifier", "ImportNamespaceSpecifier", "ImportAttribute", "ExportNamedDeclaration", "ExportDefaultDeclaration", "ExportAllDeclaration", "ExportSpecifier", "TSExportAssignment", "TSNamespaceExportDeclaration", "TSImportEqualsDeclaration", "TSExternalModuleReference", "TSInterfaceDeclaration", "TSInterfaceBody", "TSPropertySignature", "TSIndexSignature", "TSCallSignatureDeclaration", "TSMethodSignature", "TSConstructSignatureDeclaration", "TSInterfaceHeritage", "TSTypeAnnotation", "TSTypeAliasDeclaration", "TSEnumMemberName", "TSLiteralType", "TSUnionType", "TSIntersectionType", "TSParenthesizedType", "TSTypeOperator", "TSArrayType", "TSIndexedAccessType", "TSTupleType", "TSNamedTupleMember", "TSOptionalType", "TSRestType", "TSAnyKeyword", "TSStringKeyword", "TSBooleanKeyword", "TSNumberKeyword", "TSNeverKeyword", "TSIntrinsicKeyword", "TSUnknownKeyword", "TSNullKeyword", "TSUndefinedKeyword", "TSVoidKeyword", "TSSymbolKeyword", "TSThisType", "TSObjectKeyword", "TSBigIntKeyword", "TSTypeReference", "TSQualifiedName", "TSTypeParameter", "TSTypeParameterDeclaration", "TSTypeParameterInstantiation", "TSClassImplements", "TSFunctionType", "TSConstructorType", "TSMappedType", "TSInferType", "TSTypeQuery", "TSImportType", "TSImportTypeQualifiedName", "TSTypePredicate", "TSTemplateLiteralType", "TSJSDocNullableType", "TSJSDocNonNullableType", "TSJSDocUnknownType", "TSModuleDeclaration", "TSModuleBlock", "TSTypeLiteral", "TSConditionalType", "V8IntrinsicExpression", "JSXText", "JSXIdentifier", "JSXNamespacedName", "JSXOpeningFragment", "JSXClosingElement", "JSXClosingFragment", "JSXEmptyExpression"];
